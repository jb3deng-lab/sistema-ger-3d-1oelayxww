...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed z-[100] flex max-h-screen w-full flex-col items-center justify-center p-4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:max-w-[420px] pointer-events-none',
      className,
    )}
    {...props}
  />
